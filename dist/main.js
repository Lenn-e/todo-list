...
const displayController = (() => {
    ...
    function createNewProject(event) {
        ...
        const project = Object(_todo_container__WEBPACK_IMPORTED_MODULE_2__["default"])(projectName);
    ...
    function createNewTodo(event) {
        if(event.target.classList.contains("create-todo-btn")) {
            ...
            const todoText = this.querySelector("input").value;
            
            const currentProject = _organizer__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectContainer(projectID);
            const todo = Object(_todo__WEBPACK_IMPORTED_MODULE_3__["default"])(todoText);
...
flatpickr__WEBPACK_IMPORTED_MODULE_5___default()("#test", {
    enableTime: true,
...
_organizer__WEBPACK_IMPORTED_MODULE_2__["default"].initializeOrganizer(Object(_todo_container__WEBPACK_IMPORTED_MODULE_1__["default"])("Stuff I need to do"));
